...
function run_program {
    ...
    { time numactl -N0 --preferred=1 -- taskset -c 0-9,20-25 \
        sudo \
...
run_program "/users/zimooo2/duckdb/build/release/benchmark/benchmark_runner benchmark/large/tpch-sf100/.*benchmark --threads=16" model_discounted_reward_99_DuckDB-TPCH-sf100_l2 DuckDB-TPCH-sf100
...
run_program "/users/zimooo2/XSBench/openmp-threading/XSBench -t 16 -g 50000 -p 20000000" model_discounted_reward_99_XSBench_l2 XSBench
